...
const api = require('./Develop/public/assets/js/notes.js');
...
app.use(express.static(__dirname + '/Develop/public')); //setting default folder to our public folder. 
...
app.get('/notes', (req, res) =>
  res.sendFile(path.join(__dirname, 'Develop/public/notes.html')) //sets the notes to notes.html.
);
app.listen(PORT, () =>
